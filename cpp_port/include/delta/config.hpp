...
struct RuntimeConfig {
    ...
    float predictive_pid_velocity_alpha = 0.23F;
    float predictive_pid_acceleration_alpha = 0.13F;
    ...
    bool predictive_pid_latency_comp_enable = false;
    ...
    float target_association_max_distance_px = 220.0F;
    float target_association_speed_distance_gain = 0.05F;
    float target_association_iou_weight = 4.0F;
    float target_association_distance_weight = 2.0F;
    float target_association_confidence_weight = 1.0F;
    float target_association_same_class_bonus = 0.75F;
    float target_association_locked_bonus = 6.0F;
    float target_association_min_match_score = 1.25F;
    int target_association_lock_hold_frames = 3;
    bool target_association_hybrid_class_switch_enable = true;
    float target_association_hybrid_class_switch_distance_px = 90.0F;
