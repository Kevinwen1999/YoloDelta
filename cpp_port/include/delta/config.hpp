...
struct RuntimeConfig {
    ...
    float predictive_pid_velocity_alpha = 0.2F;
    float predictive_pid_acceleration_alpha = 0.1F;
    ...
    float predictive_pid_deadzone_enter_ratio = 0.3F;
    float predictive_pid_deadzone_exit_ratio = 0.35F;
